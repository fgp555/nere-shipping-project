...
export declare class T4UnstuffingController {
    ...
    create(createT4UnstuffingDto: CreateT4UnstuffingDto, files: Express.Multer.File[], mbl_code: string): Promise<import("./entities/t4_unstuffing.entity").T4UnstuffingEntity>;
