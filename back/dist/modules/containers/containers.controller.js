...
let ContainersController = class ContainersController {
    ...
    async create(createContainerDto) {
    ...
    async update(id, updateContainerDto) {
...
], ContainersController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ContainersController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], ContainersController.prototype, "remove", null);
